...
pub struct Controller {
    ...
    constrain_rsc_to_zoom_limit: qt_property!(bool; READ get_constrain_rsc_to_zoom_limit WRITE set_constrain_rsc_to_zoom_limit),
...
impl Controller {
    ...
    wrap_simple_method!(set_constrain_rsc_to_zoom_limit, v: bool; recompute);
